...
from courseinfo.views import (InstructorList, SectionList, SemesterList, StudentList, CourseList, RegistrationList,
                              ...
                              CourseDetail, InstructorCreate, SectionCreate, SemesterCreate, StudentCreate,
                              CourseCreate, RegistrationCreate, InstructorUpdate, SectionUpdate, SemesterUpdate,
                              StudentUpdate, CourseUpdate, RegistrationUpdate)
